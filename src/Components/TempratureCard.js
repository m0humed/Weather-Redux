...
import { FetchWeather } from "../redux/features/FetchData/FetchSlice";
moment.locale("ar");
...
export default function TempratureCard() {
  ...
  return isLoading? (
    <img src={process.env.PUBLIC_URL + "/start.png"} alt="loading" style={{width:"100vw" , height:"100vh"}} />
  ) : (
    <Container
      maxWidth="sm"
      sx={{
            ...
            >
              ...
              >
                <Typography variant="p" sx={{ fontSize: "90px" }}>
                  {Math.floor(Number(data.temp) - 273.15)}
                </Typography>
                {/* <WbSunnyIcon sx={{ fontSize: "40px" }} /> */}

                <img
                  src={`https://openweathermap.org/img/wn/${data.imgLink}@2x.png`}
                  alt="witherState"
                />
              </div>
